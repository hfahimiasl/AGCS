...
public enum UsbSerialProber {
    ...
    public static List<UsbSerialDriver> findAllDevices(final UsbManager usbManager) {
        ...
        //Log.i("AGCS_UsbSerialProber", "Looking for USB devices");
        // For each UsbDevice, call probe() for each prober.
        for (final UsbDevice usbDevice : usbManager.getDeviceList().values()) {
            //Log.i("AGCS_UsbSerialProber", "Probing device: " + usbDevice.getDeviceName() + " mid: " + usbDevice.getVendorId() + " pid: " + usbDevice.getDeviceId());
