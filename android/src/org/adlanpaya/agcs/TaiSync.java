...
//        Log.i("AGCS_TaiSync", "Open");
                ...
                try {
                    while (bytesRead >= 0) {
                        ...
                        if (bytesRead > 0)
                        {
                            ...
                            {
                                vMaj = mBytes[19];
                                // Log.i("AGCS_TaiSync", "Got protocol version message vMaj = " + mBytes[19]);
                                ...
                                // Log.i("AGCS_TaiSync", "Read 2 port = " + dPort + " length = " + dLength);
                    ...
                    Log.e("AGCS_TaiSync", "Exception: " + e);
                    e.printStackTrace();
                } finally {
                    close();
                }
    ...
    private void sendTaiSyncMessage(byte protocol, int dataPort, byte[] data, int dataLen) throws IOException
    {
        ...
        // Log.i("AGCS_TaiSync", "Sending to " + dataPort + " length = " + len);
