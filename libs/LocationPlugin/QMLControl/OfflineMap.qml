...
import QGroundControl.MapEngineManager   1.0
...
Item {
    ...
    Item {
        ...
        Row {
            ...
            QGCButton {
                ...
                onClicked: {
                    QGroundControl.mapEngineManager.importAction = MapEngineManager.ActionNone
                    importDialog.open()
                }
            }
            QGCButton {
    ...
    Popup {
        ...
        Column {
            ...
            anchors.centerIn:   parent
            QGCLabel {
                text:               QGroundControl.mapEngineManager.importAction === MapEngineManager.ActionExporting ? qsTr("Tile Set Export Progress") : qsTr("Tile Set Export Completed")
            ...
            BusyIndicator {
                visible:        QGroundControl.mapEngineManager ? QGroundControl.mapEngineManager.importAction === MapEngineManager.ActionExporting : false
                running:        QGroundControl.mapEngineManager ? QGroundControl.mapEngineManager.importAction === MapEngineManager.ActionExporting : false
    ...
    Popup {
        ...
        Column {
            ...
            QGCLabel {
                text: {
                    if(QGroundControl.mapEngineManager.importAction === MapEngineManager.ActionNone) {
                        return qsTr("Map Tile Set Import");
                    } else if(QGroundControl.mapEngineManager.importAction === MapEngineManager.ActionImporting) {
            ...
            ProgressBar {
                ...
                from:           0
                to:             100
                visible:        QGroundControl.mapEngineManager.importAction === MapEngineManager.ActionImporting
                value:          QGroundControl.mapEngineManager.actionProgress
                anchors.horizontalCenter: parent.horizontalCenter
            }
            BusyIndicator {
                visible:        QGroundControl.mapEngineManager.importAction === MapEngineManager.ActionImporting
                running:        QGroundControl.mapEngineManager.importAction === MapEngineManager.ActionImporting
            ...
            Column {
                ...
                QGCRadioButton {
                    ...
                    visible:        QGroundControl.mapEngineManager.importAction === MapEngineManager.ActionNone
                }
                QGCRadioButton {
            ...
            QGCButton {
                ...
                visible:        QGroundControl.mapEngineManager.importAction === MapEngineManager.ActionDone
                anchors.horizontalCenter: parent.horizontalCenter
                onClicked: {
                    showList();
                    importDialog.close()
