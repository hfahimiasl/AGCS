...
//  Adapted for AGCS by: Gus Grubba 2015
...
{
    qDebug() << "Registering Native Functions";
    ...
    JNINativeMethod javaMethods[] {
        ...
        {"agcsLogDebug",                 "(Ljava/lang/String;)V",    reinterpret_cast<void *>(jniLogDebug)},
        {"agcsLogWarning",               "(Ljava/lang/String;)V",    reinterpret_cast<void *>(jniLogWarning)}
    };
    ...
    if (val < 0) {
        ...
        qDebug() << "Native Functions Registered";
    }
...
{
    rwMode = mode;
    qDebug() << "Opening" << systemLocation.toLatin1().data();
...
void QSerialPortPrivate::close()
{
    ...
    qDebug() << "Closing" << systemLocation.toLatin1().data();
    cleanJavaException();
